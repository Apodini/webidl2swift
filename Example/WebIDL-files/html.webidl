...
Document includes DocumentAndElementEventHandlers;partial interface mixin DocumentOrShadowRoot {
...
HTMLLinkElement includes LinkStyle;[Exposed=Window]
...
HTMLStyleElement includes LinkStyle;[Exposed=Window]
...
HTMLBodyElement includes WindowEventHandlers;[Exposed=Window]
...
HTMLAnchorElement includes HTMLHyperlinkElementUtils;[Exposed=Window]
...
HTMLAreaElement includes HTMLHyperlinkElementUtils;[Exposed=Window]
...
callback BlobCallback = undefined (Blob? blob);typedef (HTMLImageElement or
...
Path2D includes CanvasPath;[Exposed=(Window,Worker)]
...
OffscreenCanvasRenderingContext2D includes CanvasPath;[Exposed=Window]
...
callback FunctionStringCallback = undefined (DOMString data);[Exposed=Window]
...
typedef EventHandlerNonNull? EventHandler;[LegacyTreatNonObjectAsNull]
callback OnErrorEventHandlerNonNull = any ((Event or DOMString) event, optional DOMString source, optional unsigned long lineno, optional unsigned long colno, optional any error);
typedef OnErrorEventHandlerNonNull? OnErrorEventHandler;[LegacyTreatNonObjectAsNull]
callback OnBeforeUnloadEventHandlerNonNull = DOMString? (Event event);
typedef OnBeforeUnloadEventHandlerNonNull? OnBeforeUnloadEventHandler;interface mixin GlobalEventHandlers {
...
WorkerGlobalScope includes WindowOrWorkerGlobalScope;[Exposed=Window]
interface DOMParser {
  constructor();
...
Navigator includes NavigatorConcurrentHardware;interface mixin NavigatorID {
...
DedicatedWorkerGlobalScope includes AnimationFrameProvider;[Exposed=(Window,Worker,AudioWorklet)]
...
typedef (WindowProxy or MessagePort or ServiceWorker) MessageEventSource;[Exposed=(Window,Worker)]
...
Worker includes AbstractWorker;[Exposed=Window]
interface SharedWorker : EventTarget {
  constructor(USVString scriptURL, optional (DOMString or WorkerOptions) options = {});

  readonly attribute MessagePort port;
};
SharedWorker includes AbstractWorker;interface mixin NavigatorConcurrentHardware {
...
WorkerNavigator includes NavigatorConcurrentHardware;[Exposed=Worker]
...
interface WorkletGlobalScope {};[Exposed=Window, SecureContext]
interface Worklet {
...
Window includes WindowSessionStorage;interface mixin WindowLocalStorage {
  readonly attribute Storage localStorage;
};
Window includes WindowLocalStorage;[Exposed=Window]
...
HTMLFrameSetElement includes WindowEventHandlers;[Exposed=Window]
